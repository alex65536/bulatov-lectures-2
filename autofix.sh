...
sedfix 's/([^a-zA-Z\]|^)(lim|sin|cos|tan|tg|sup|inf|mes|rank|diam|fix|arctan|arctg|sinh|cosh|ln|Arcsin|Arccos|Arctg|Arcctg|Arsh|Arch|Arth|Arcth|Ln|Arg|Re|Im)/\1\\\2/g'
