...
\end{equation}
Полагая, в соответствии с \eqref{lec25:3}, для $\forall z \in D \implies
\exists! f(z) \in \C$.
 Полагая 
$\begin{cases} 
...
соответствующий угол. Для этого, использовав экспоненциальную формулу, имеем:
			...
			\end{gathered}\]
			 ...
			 \end{cases}
			\end{equation}
В таком случае имеем параллельный перенос на вектор, соответствующий
...
растяжения/сжатия и поворота.
	...
	\end{cases}
	\end{equation}
Если $c = 0, d \ne 0$, то $w \overset{\eqref{lec25:7}}{=} \frac{az + b}{d} =
a_0{z} + b_0, \
	\begin{cases} 
 	 a_0  = \frac{a}{d} \in \C\\
  	 b_0  = \frac{b}{d} \in \C
	\end{cases}
$ --- переходим к линейной ФКП. В этом случае $\Delta = \begin{vmatrix}a&b\\
c&d\end{vmatrix} = ad - bc = 0$.
