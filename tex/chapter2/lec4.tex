...
\begin{proof}
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			% TODO: need a little skip between the lines
...
\begin{rem}
	%TODO: check if label works to (5) - it doesn't exist at the 
	%TODO time of typesetting this lecture
...
\begin{proof}
	...
	\begin{enumerate}
		...
		a_n(x - x_0)^n$, имеем:
		%TODO: check why vertical skip is so big
...
\begin{rems}
	...
	\begin{enumerate}
		...
		%TODO: check if label works - it doesn't exist at the 
		%TODO time of typesetting this lecture
...
\begin{rems}
	...
	\begin{enumerate}
		...
		%TODO: mb dont \[ \] - to reduce vertical skip
...
\begin{proof}
	...
	\end{gathered} \]
	Радиусы у \eqref{lec3:4} и у \eqref{lec4:10} совпадают $\implies$ 
...
\begin{thm}[О почленном интегрировании степенного ряда]
	...
	\end{equation}
	У исходного ряда \eqref{lec3:1} - \eqref{lec3:2} и продифференцированного
	ряда 
