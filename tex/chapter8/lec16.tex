...
\begin{thm}[о существовании конечного положительного периода]
 ...
 \begin{proof}
	 ...
	 периодом $T >
	  ...
	  $f_1(x)
	   = \frac{\sin{2\pi x}}{T}$; $f_2(x) = \frac{\cos{2\pi x}}{T}$ являются 
	   $T$-периодическими.
...
множество, на котором можно ввести ряды Фурье.
\end{erem}
...
Кроме того, можно показать, что система \[\frac{1}{\sqrt2l},\ \frac{1}{\sqrt 
