	...
	\end{enumerate}
		...
		\begin{examples}
			\begin{enumerate}
				...
				\draw[shift={(-1,0)},color=black] (0pt,2pt) -- (0pt,-2pt) node[below] {\footnotesize $-\pi$};
				\draw[->,color=black] (0,-1.25) -- (0,1.25 )node[right] {\footnotesize $S(x)$};
				\draw[shift={(0,1)},color=black] (2pt,0pt) -- (-2pt,0pt) node[left] {\footnotesize $\pi$};
				\draw[shift={(0,-1)},color=black] (2pt,0pt) -- (-2pt,0pt) node[left] {\footnotesize $-\pi$};
				\draw[color=black] (0pt,-10pt) node[right] {\footnotesize $0$};
				\draw[-] (0,0)-- (1,1);
				\draw[-] (0,0)-- (-1,1);
