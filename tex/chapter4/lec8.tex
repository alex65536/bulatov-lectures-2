...
$\eqref{lec8:4}$ неограниченна в $a$, т.~е. $f(a + 0) = \infty$. В этом случае 
...
\left] c,\; b \right]$ и неограниченна в точке $c$, т.~е. $f(c + 0) = f(c - 0) 
...
Где у каждого из интегралов подынтегральная функция неограниченна лишь на 
