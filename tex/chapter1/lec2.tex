...
Пусть выполнены условия:
	...
	$E=[a,b]$
		...
		\item $f(x)$ непрерывна на $E=[a,b]$
	\end{enumerate}
Тогда ряд $\sum U_n(x) \overset{[a,b]}{\rightrightarrows} f(x)$
\end{thm}	
...
следующими свойствами:
  ...
  r_n(x) \in C([a,b])$, т.~к. $f(x) \in C([a,b])$ и
	...
	$r_n(x)$ как последовательность монотонно убывает.
...
Пусть для ФП $f_n(x),\ n \in \N,\ x \in [a,b]$ выполнены условия:
	\begin{enumerate}
		\item $\forall n \in \N \implies f_n(x) \in C([a,b])$
		\item $\forall \fix \ x \in [a,b] \implies
		(f_n(x))$ --- монотонная последовательность 
		\item $f_n(x) \overset{[a,b]}
		{\underset{n \to \infty}\longrightarrow} f(x) \in C([a,b])$
	\end{enumerate}			
Тогда $f_n(x) \overset{[a,b]} {\underset{n \to \infty}\rightrightarrows}
f(x) \in C([a,b])$
\end{thm}
...
\forall n \in N, \ \forall x \in E$)
	\item
	$\forall \fix \ x \in E \implies (a_n(x))$ --- монотонная 
последовательность
\end{enumerate}
Тогда ряд $\sum a_n(x)b_n(x) \overset{E}{\rightrightarrows}$
\end{thm}	
...
последовательность
\end{enumerate}
Тогда ряд $\sum a_n(x)b_n(x) \overset{E}
...
\begin{proof}
	\;
		...
		Докажем, что $\exists \underset{x \to x_0}{\lim} f(x) = 
